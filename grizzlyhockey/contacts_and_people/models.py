...
class PersonLite(models.Model):
    title = models.ForeignKey(
        ...
        on_delete=models.SET_NULL)
    given_name = models.CharField(max_length=50, blank=True, null=True, verbose_name="Имя")
    middle_names = models.CharField(max_length=100, blank=True, null=True, verbose_name="Отчество")
