...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_pollplugin', (
            ...
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['polls.Poll'])),
        ))
        db.send_create_signal('polls', ['PollPlugin'])
    ...
    models = {
        ...
        'polls.pollplugin': {
            ...
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['polls.Poll']"})
        }
    }
