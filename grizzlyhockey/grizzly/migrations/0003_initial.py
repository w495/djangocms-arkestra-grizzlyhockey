...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('grizzly_playerstatus', (
            ...
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='playerstatus_item', null=True, on_delete=models.PROTECT, to=orm['links.ExternalLink'])),
    ...
    models = {
        ...
        'grizzly.playerstatus': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'external_url': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'playerstatus_item'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['links.ExternalLink']"}),
